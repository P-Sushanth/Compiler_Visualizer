...
vi.mock('@/features/semantic/SemanticViewer', () => ({
  SemanticViewer: () => <div data-testid="semantic-view">Mock Semantic Viewer</div>,
}));
...
vi.mock('@/features/optimizer/OptimizerViewer', () => ({
  OptimizerViewer: () => <div data-testid="optimizer-view">Mock Optimizer Viewer</div>,
}));
vi.mock('@/features/assembly/AssemblyViewer', () => ({
  AssemblyViewer: () => <div data-testid="assembly-view">Mock Assembly Viewer</div>,
}));
vi.mock('@/features/compare/ComparisonViewer', () => ({
  ComparisonViewer: () => <div data-testid="compare-view">Mock Comparison Viewer</div>,
}));
