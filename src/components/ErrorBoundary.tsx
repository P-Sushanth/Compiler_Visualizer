      ...
      return (
        <div className="flex flex-col h-full w-full items-center justify-center p-6 bg-bg-primary text-center">
          <div className="bg-bg-tertiary border border-border-primary rounded-xl p-8 flex flex-col items-center max-w-md w-full shadow-lg border-t-4 border-t-error">
            <div className="w-12 h-12 rounded-full bg-error bg-opacity-15 flex items-center justify-center text-error mb-4 shadow-sm border border-error border-opacity-35">
            ...
            <button
              ...
              className="w-full py-2 bg-info hover:bg-opacity-95 text-text-primary font-mono text-sm rounded border border-info border-opacity-35 font-bold transition-all hover:scale-[1.01] active:scale-[0.99] cursor-pointer"
            >
              Reset Application
            </button>
          </div>
