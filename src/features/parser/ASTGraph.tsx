      ...
      {isBeginner && (
        <div className="p-4 bg-bg-tertiary border-b border-border-primary text-xs leading-relaxed text-text-secondary shrink-0 z-10">
          <h3 className="font-bold text-info mb-1 uppercase tracking-wider text-[10px]">
            What is Syntax Analysis & AST?
          </h3>
          <p>
            The <strong>Parser</strong> translates the flat sequence of tokens
            into a nested <strong>Abstract Syntax Tree (AST)</strong>. This tree
            represents the logical structure of your C code according to
            grammatical rules, mapping variables, expressions, and statements
